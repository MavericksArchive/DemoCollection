...
def testPipeline():
    ...
    if run_papyrus:
        ...
        has_use_case_1_device = topic_output_json['user_input_desc'].find('MRE-Edge2.cisco.com') >= 0
        ...
        try:
            ...
            user_response_list = [user_response]
        MyUserResponse = dict(
...
def papyrus_output_formatting(topic_output_json, user_response, key_pair = ['Command', 'Signature']):
    import re
